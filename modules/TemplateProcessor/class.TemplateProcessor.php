...
require 'interface.iConstruction.php';
require 'class.Construction.php';

//Constructions
require 'constructions/class.MainConstruction.php';
require 'constructions/class.HtmlConstruction.php';
include 'constructions/class.ValueConstruction.php';
include 'constructions/class.IfElseConstruction.php';
include 'constructions/class.ForeachConstruction.php';
include 'constructions/class.IfElseContainerConstruction.php';
include 'constructions/class.ExpressionConstruction.php';

use core\module\IModule;
use Exception;
use core\log\Log;
use modules\TemplateProcessor\constructions\MainConstruction;

/**
 * Template processor.
 * @package modules\TemplateProcessor
 */
final class TemplateProcessor implements IModule
{
	...
	public static function BuildSyntaxTree($templateData, iConstruction $parent)
	{
		...
		static $templateRules = array(
			'html'		=> 'modules\TemplateProcessor\constructions\HtmlConstruction',
			'value'		=> 'modules\TemplateProcessor\constructions\ValueConstruction',
			'foreach'	=> 'modules\TemplateProcessor\constructions\ForeachConstruction',
			'for'		=> 'modules\TemplateProcessor\constructions\ForConstruction',
			'while'		=> 'modules\TemplateProcessor\constructions\WhileConstruction',
			'if'		=> 'modules\TemplateProcessor\constructions\IfElseConstruction'
		);
